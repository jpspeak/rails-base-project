...
ActiveRecord::Schema.define(version: 2021_04_27_103626) do
  ...
  create_table "buyers_stocks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buyer_id"], name: "index_buyers_stocks_on_buyer_id"
  ...
  create_table "stocks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["broker_id"], name: "index_stocks_on_broker_id"
  end
